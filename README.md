...
- 원하는 게시글을 검색을 통하여 볼 수 있고 게시글에 올려진 파일을 자유롭게 다운로드드하여 사용이 가능합니다.
<br>
...
<br>
- 팀 생성시 팀원들이 자유롭게 사용할 수 있는 공유 탬플릿이 주어지며 자유롭게 이용이 가능합니다.
<br>
<br>
...
* 문제2<br>
★ 크롤링<br>
이클립스 내에서 파이썬 코드 실행 (pyDev 플러그인 설치) JDK버전 호환성문제로 인해 플러그인 비정상 설치 <br>
 -> eGovFrame전화 - 무슨이유인지 모르겠으나 해결방법을 못 찾았다 연락받음 <br>
 -> GitHub에 Repository 생성 이후 파이썬 코드 업로드 후 Github Actions 코드 작성 후 해결<br><br>
  ![image](https://ifh.cc/g/hxWno9.png)
