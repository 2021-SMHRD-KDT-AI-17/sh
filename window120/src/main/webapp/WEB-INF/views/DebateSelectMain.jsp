    ...
    <div class="window-body" >
        <div class="sunken-panel" style="height: 580px; width: 970px;">
            ...
            <c:choose>
               <c:when test="${d_size<20 }">
                  <br>
                  <p id="page1" style="text-align: center; font-size:20px;">페이지 : <a href="selectDebate1">[1]</a><span></p> 
                  <br>
                  <br>
               </c:when>
               <c:when test="${d_size>=20 and d_size<40 }">
                  <br>
                  <p id="page1" style="text-align: center; font-size:20px;">페이지 : <a href="selectDebate1">[1]</a><span></span><a href="selectDebate2">[2]</a><span></p>
                  <br>
                  <br>
               </c:when>
               <c:when test="${d_size>=40}">
                  <br>
                  <p id="page1" style="text-align: center; font-size:20px;"">페이지 : <a href="selectDebate1">[1]</a><span></span><a href="selectDebate2">[2]</a><span></span><a href="selectDebate3">[3]</a></p>
                  <br>
                  <br>
               </c:when>
            </c:choose>
