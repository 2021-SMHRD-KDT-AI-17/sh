    ...
    <div class="window-body" >
        <div class="sunken-panel" style="height: 580px; width: 970px;">
            <table class="interactive">
               ...
               <c:when test="${f_size>=40 and f_size<60 }">
                     <c:choose>
                     <c:when test="${page3 eq '1' }">
                     <c:forEach items="${f_list }" var="f" begin="0" end="19" step="1" varStatus="s">
                     <tr>
            ...
            <c:choose>
               <c:when test="${f_size<20 }">
                  <br>
                  <p id="page1" style="text-align: center; font-size:20px;">페이지 : <a href="selectFboard1">[1]</a><span></p> 
                  <br>
                  <br>
               </c:when>
               <c:when test="${f_size>=20 and f_size<40 }">
                  <br>
                  <p id="page1" style="text-align: center; font-size:20px;">페이지 : <a href="selectFboard1">[1]</a><span></span><a href="selectFboard2">[2]</a><span></p>
                  <br>
                  <br>
               </c:when>
               <c:when test="${f_size>=40}">
                  <br>
                  <p id="page1" style="text-align: center; font-size:20px;"">페이지 : <a href="selectFboard1">[1]</a><span></span><a href="selectFboard2">[2]</a><span></span><a href="selectFboard3">[3]</a></p>
                  <br>
                  <br>
               </c:when>
            </c:choose>
...
document.addEventListener("DOMContentLoaded", function() {
     ...
     var dataTab = document.querySelector('[href="#data-tab"]');
     dataTab.parentNode.setAttribute('aria-selected', 'true');

     // 질문 게시판 탭 컨텐츠를 활성화
     var dataTabContent = document.getElementById('data-tab');
