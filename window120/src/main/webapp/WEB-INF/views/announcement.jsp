...
<script type="text/javascript" src="https://oapi.map.naver.com/openapi/v3/maps.js?ncpClientId=s1amhqz5qc"></script>
		...
		<div class="window tab-content" role="tabpanel" id="announce-tab"
			...
			<div class="window-body" style="position: fixed;">
				<div class="sunken-panel" style="height: 610px; width: 1270px;">
					...
					<img alt="" src="resources/assets/images/smhrd1.png"
						style="position: relative; top: 330px; width: 100%;">
				</div>
			</div>
		</div>
								...
								<td style="height: 100px; width: 25%; padding: 10px;">
									<button style="width: 100%; height: 100%; padding: 5px;">
										...
										<p style="font-size: 15px; text-align: center;">커피쿠폰
											EVENT!</p>
										<p style="font-size: 13px; text-align: center;">강의 시간에 열심히
											질문 및 대답하고</p>
								...
								<td style="height: 100px; width: 25%; padding: 10px;">
									<button style="width: 100%; height: 100%; padding: 5px;">
										...
										<p style="font-size: 13px; text-align: center;">블로그에 내
											포트폴리오를 펼쳐보세요</p>
										<p style="font-size: 13px; text-align: center;">수료증 및 활동비
											10만원까지 지급!</p>
									</button>
								</td>
							...
							<tr>
								...
								<td>
									<div>
										...
										<p style="font-size:15px;  font-weight: bold;"> 전남여고, 국립아시아문화전당, 예술의거리 입구, 문화전당역 지하철 역
											국립아시아문화전당역(1호선, 4번출구)</p>
									</div>
								</td>
							</tr>
						</tbody>
