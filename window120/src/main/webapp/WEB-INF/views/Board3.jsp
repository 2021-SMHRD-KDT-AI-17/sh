        ...
        <div class="sunken-panel" style="height: 580px; width: 970px;">
            <table class="interactive">
               ...
               <c:choose>
                  ...
                  <c:forEach items="${f_list }" var="f" begin="0" end="14" step="1" varStatus="s">
                     <tr>
                        <td>${s.count }</td>
                        <td><a href="FboardContent?fb_idx=${f.fb_idx }">${f.fb_title }</a></td>
                        <td>${f.user_id }</td>
               ...
               <c:when test="${page3 eq '2' }">
                     <c:forEach items="${f_list }" var="f" begin="15" end="${f_size }" step="1" varStatus="s">
                     <tr>
                        <td>${s.count+15 }</td>
                        <td><a href="FboardContent?fb_idx=${f.fb_idx }">${f.fb_title }</a></td>
                        <td>${f.user_id }</td>
               ...
               <c:when test="${f_size>=30 and f_size<45 }">
                     <c:choose>
                     <c:when test="${page3 eq '1' }">
                     <c:forEach items="${f_list }" var="f" begin="0" end="14" step="1" varStatus="s">
                     <tr>
                     ...
                     <c:when test="${page3 eq '2' }">
                     <c:forEach items="${f_list }" var="f" begin="15" end="29" step="1" varStatus="s">
                     <tr>
                        <td>${s.count+15 }</td>
                        <td><a href="FboardContent?fb_idx=${f.fb_idx }">${f.fb_title }</a></td>
                        <td>${f.user_id }</td>
