...
<body>
	...
	<div class="sunken-panel" id="board" style="height: 100%; width: 100%;">
		<form action="FbaordInsert" method="post" enctype="multipart/form-data">
			<table class="interactive" id="list" style="height: 100%; width: 100%;">
				<thead style="font-size: 30px;">
				<tr>
					<th style="width:20%">제목</th>
					<th><input style="width:100%; height: 80%; padding:0; border: none; font-size:20px;" type="text" name="fb_title"></th>
				</tr>
				<tr>
				...
				<th><input type="file" style="float: left;" name="fb_file"></th>
				</tr>
				<tr>
					<th colspan="2">내용</th>
				</tr>
