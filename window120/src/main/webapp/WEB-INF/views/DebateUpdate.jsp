...
<body>
	<div class="sunken-panel" id="board" style="height: 100%; width: 100%;">
		<form action="DebateUpdate?d_idx=${debate.d_idx }" method="post"
			...
			<table class="interactive" id="list"
				...
				<thead style="font-size: 30px;">
					<tr>
						...
						<th><input
							...
							type="text" name="d_title" value="${debate.d_title }">
						</th>
					</tr>
					...
					<tr>
						...
						<th><input style="width: 100%; height: 80%; font-size: 20px;"
							type="text" name="user_id" readonly value="${debate.user_id }">
						</th>
					</tr>
					<tr>
						<th style="width: 20%">파일</th>
						<th><input type="file" style="float: left;" name="d_file" value="${debate.d_file }"></th>
					</tr>
					<tr>
						<th colspan="2">내용</th>
					</tr>
				...
				<tr>
					<td colspan="2"><textarea rows="10" style="width:100%; height: 100%; font-size:20px;"
							name="d_content">${debate.d_content } </textarea></td>
				</tr>
				<tr>
					<td colspan="2">
