    ...
    <div class="window-body" >
        <div class="sunken-panel" style="height: 800px; width: 970px;">
            ...
            <!-- 페이징 구현 -->
             ...
             <a href="goDebateWrite"><button id="writer">작성하러가기</button></a>
             
             <c:choose>
               <c:when test="${d_size<20 }">
                  <tr><td id="page1">페이지 : <a href="goDebateBoard">[1]</a><span></td><tr>
               </c:when>
               <c:when test="${d_size>=20 and d_size<40 }">
                  <tr><td id="page1">페이지 : <a href="goDebateBoard">[1]</a><span></span><a href="goDebateMain2">[2]</a><span></td><tr>
               </c:when>
               <c:when test="${d_size>=40}">
                  <tr><td id="page1">페이지 : <a href="goDebateBoard">[1]</a><span></span><a href="goDebateMain2">[2]</a><span></span><a href="goDebateMain3">[3]</a></td><tr>
               </c:when>
            </c:choose>   
               </tbody>
            </table>
